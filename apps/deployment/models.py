...
class Project(TimeAbstract):
    ...
    status = models.CharField(max_length=20, default='', verbose_name="状态")
    excludes = models.TextField(default='', verbose_name='排除')
    ...
    task_envs = models.TextField(default='', verbose_name='全局变量')
    prev_deploy = models.TextField(default='', verbose_name='deploy前置')
    post_deploy = models.TextField(default='', verbose_name='deploy后置')
    prev_release = models.TextField(default='', verbose_name='release前置')
    post_release = models.TextField(default='', verbose_name='release后置')
    version_num = models.IntegerField(blank=True, null=True, verbose_name='版本数量')
    repo_url = models.CharField(default='', max_length=200)
    repo_mode = models.CharField(default='', max_length=30)
    server_ids = models.CharField(default='', max_length=10, verbose_name='关联主机')
    ...
    app_log_path = models.CharField(default='', max_length=150, verbose_name='日志目录')
    app_log_file = models.CharField(default='', max_length=150, verbose_name='日志文件')
    user_id = models.CharField(max_length=100, default='', verbose_name='关联用户id')
