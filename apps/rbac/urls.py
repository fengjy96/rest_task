...
urlpatterns = [
    ...
    # 获取组织树
    path(r'organization/tree/', organization.OrganizationTreeView.as_view(), name='organizations_tree'),
    # 获取组织用户树
    path(r'organization/user/tree/', organization.OrganizationUserTreeView.as_view(),
         name='organization_user_tree'),
    # 获取菜单树
    path(r'menu/tree/', menu.MenuTreeView.as_view(), name='menus_tree'),
    # 获取权限树
    path(r'permission/tree/', permission.PermissionTreeView.as_view(), name='permissions_tree'),
    # 获取用户列表
    path(r'user/list/', user.UserListView.as_view(), name='user_list'),
    # 修改用户头像
    path(r'user/avatar/upload', user.UserAvatarUploadView.as_view(), name='user_avatar_upload'),
]
