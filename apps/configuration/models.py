...
class ProjectStatus(models.Model):
    ...
    项目状态
    """
    index = models.IntegerField(verbose_name='排序序号')
    num = models.IntegerField(verbose_name='真实序号')
    key = models.CharField(max_length=30, verbose_name='状态名')
    value = models.CharField(max_length=30, verbose_name='状态值')
    text = models.CharField(max_length=30, verbose_name='状态值')
